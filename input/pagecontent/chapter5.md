...
{% include img.html img="figure3.svg" caption="Figure 3: Conformance Relationships" width="50%" %}
...
{% include img.html img="figure4.svg" caption="Figure 4: Portion of the Functional Model hierarchical structure" width="50%" %}
